jQuery(function($){
  ...
  $('.beem-admin').on('click','.beem-restore-defaults',function(){return window.confirm('Restore all English, Arabic, and French homepage copy and repeatable items to their defaults? Your images, account links, and email settings will be kept.')});
