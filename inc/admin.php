...
function beem360_repeater_schemas(): array {
    ...
    return [
      ...
      'problem_bad'=>['title'=>'Problem rows','description'=>'Items in the “without Beem 360” card.','fields'=>['label'=>['label'=>'Item','type'=>'i18n_text','langs'=>$langs],'meta'=>['label'=>'Location / state','type'=>'i18n_text','langs'=>$langs]]],
      'problem_good'=>['title'=>'Solution comparison rows','description'=>'Items in the connected Beem 360 card.','fields'=>['label'=>['label'=>'Item','type'=>'i18n_text','langs'=>$langs],'meta'=>['label'=>'Location / state','type'=>'i18n_text','langs'=>$langs]]],
