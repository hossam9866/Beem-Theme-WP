...
function beem360_default_items(): array {
    ...
    return [
        ...
        'pillars' => [
            ['icon'=>'bi-journal-text','color'=>'orange','title'=>$t('Smart Notes & Reminders','الملاحظات الذكية والتذكيرات','Notes intelligentes & rappels'),'text'=>$t('Capture important context, organize it instantly, and make sure critical follow-ups happen on time.','سجّل المعلومات المهمة، نظّمها بسهولة، وتأكد من أن كل متابعة تتم في وقتها.','Consignez les informations importantes, organisez-les facilement et assurez-vous que chaque suivi intervienne au bon moment.'),'chips'=>$t("Timed reminders\nCategories\nFull-text search","تذكيرات مجدولة\nتصنيفات\nبحث شامل","Rappels programmés\nCatégories\nRecherche complète"),'image'=>$asset('06-smart-notes.jpg'),'url'=>''],
            ['icon'=>'bi-calendar3','color'=>'blue','title'=>$t('Unified Scheduling','الجدولة الموحدة','Planification unifiée'),'text'=>$t('Coordinate meetings, deadlines, and upcoming priorities through one shared schedule.','اجمع الاجتماعات والمواعيد النهائية والأولويات القادمة في جدول واحد يسهل متابعته.','Centralisez réunions, échéances et priorités à venir dans un agenda partagé, simple à consulter.'),'chips'=>$t("Week view\nCalendar sync\nDeadlines","عرض أسبوعي\nمزامنة التقويم\nالمواعيد النهائية","Vue hebdomadaire\nSynchronisation du calendrier\nÉchéances"),'image'=>$asset('07-week-view.jpg'),'url'=>''],
            ['icon'=>'bi-bar-chart-line','color'=>'teal','title'=>$t('Real-time Analytics','التحليلات اللحظية','Analyses en temps réel'),'text'=>$t('Track business health, spending, and key metrics as activity unfolds.','تابع مؤشرات الأداء والإنفاق وحالة المشروعات مع تطور العمل، دون انتظار إعداد التقارير يدويًا.','Suivez les indicateurs clés, les dépenses et l’état des projets au fil de l’exécution, sans attendre la production manuelle de rapports.'),'chips'=>$t("Health score\nMonthly burn\nLive KPIs","مؤشر الأداء\nمعدل الإنفاق الشهري\nمؤشرات مباشرة","Indicateur de performance\nDépenses mensuelles\nKPI en temps réel"),'image'=>$asset('08-analytics.jpg'),'url'=>''],
            ['icon'=>'bi-check2-square','color'=>'orange','title'=>$t('Task Tracking','متابعة المهام','Suivi des tâches'),'text'=>$t('Make every responsibility explicit with an owner, priority, deadline, and status.','اجعل كل مهمة واضحة: من المسؤول عنها، وما أولويتها، ومتى يجب إنجازها، وإلى أين وصلت.','Donnez à chaque tâche un cadre clair : responsable, priorité, échéance et état d’avancement.'),'chips'=>$t("Kanban board\nPriorities\nOwners","لوحة كانبان\nالأولويات\nالمسؤولون","Tableau Kanban\nPriorités\nResponsables"),'image'=>$asset('09-task-board.jpg'),'url'=>''],
        ],
        'problem_bad' => [
            ['label'=>$t('Task updates','تحديثات المهام','Mises à jour des tâches'),'meta'=>$t('scattered across conversations','موزعة بين المحادثات','dispersées dans les conversations')],['label'=>$t('Project files','ملفات المشروعات','Fichiers projet'),'meta'=>$t('stored in separate folders','محفوظة في مجلدات منفصلة','stockés dans des dossiers séparés')],['label'=>$t('Budgets','الميزانيات','Budgets'),'meta'=>$t('tracked outside the workflow','تُتابع بعيدًا عن سير التنفيذ','suivis en dehors du processus d’exécution')],['label'=>$t('Reports','التقارير','Rapports'),'meta'=>$t('built manually','تُعد يدويًا','préparés manuellement')],['label'=>$t('Overall status','الوضع العام','Situation globale'),'meta'=>$t('difficult to assess quickly','يحتاج إلى وقت لفهمه','longue à reconstituer')],
        ],
        'problem_good' => [
            ['label'=>$t('Task updates','تحديثات المهام','Mises à jour des tâches'),'meta'=>$t('linked to the activity','مرتبطة بما يجري فعليًا','reliées à l’activité réelle')],['label'=>$t('Project files','ملفات المشروعات','Fichiers projet'),'meta'=>$t('available where they are needed','متاحة حيث تحتاجها','disponibles là où ils sont utiles')],['label'=>$t('Budgets','الميزانيات','Budgets'),'meta'=>$t('tracked alongside delivery','تُتابع بالتوازي مع التنفيذ','suivis en parallèle de l’exécution')],['label'=>$t('Reports','التقارير','Rapports'),'meta'=>$t('generated from current activity','تُنشأ من البيانات الحالية','générés à partir des données actuelles')],['label'=>$t('Overall status','الوضع العام','Situation globale'),'meta'=>$t('easy to review at a glance','واضح من نظرة سريعة','lisible en un coup d’œil')],
        ],
        'hub_left' => [
...
function beem360_defaults(): array {
    return [
        ...
        'copy' => [
            ...
            'pillars_text' => ['en'=>'Bring planning, scheduling, measurement, and accountability into the flow of everyday execution.','ar'=>'خطط للأولويات، نسّق المواعيد، تابع الأداء، وحدد المسؤوليات بوضوح — ضمن تجربة عمل واحدة ومتكاملة.','fr'=>'Planifiez les priorités, coordonnez les échéances, suivez la performance et clarifiez les responsabilités — dans un même flux de travail.'],
            ...
            'problem_text' => ['en'=>'Tasks move in one place. Files live in another. Budgets sit in spreadsheets. Reports are rebuilt manually. When information is fragmented, teams spend more time piecing together status and less time moving priorities forward.','ar'=>'المهام في مكان، والملفات في مكان آخر، والميزانيات داخل جداول منفصلة، والتقارير تحتاج إلى إعداد يدوي في كل مرة. ومع تشتت المعلومات، يضيع وقت أكبر في جمع التحديثات وفهم الوضع الحالي بدلًا من دفع الأولويات إلى الأمام.','fr'=>'Les tâches sont d’un côté, les fichiers ailleurs, les budgets dans des feuilles de calcul distinctes et les rapports doivent être préparés manuellement à chaque fois. Quand l’information est fragmentée, les équipes passent davantage de temps à rassembler les mises à jour et à comprendre la situation qu’à faire avancer les priorités.'],
            ...
            'cta_text' => ['en'=>'Ready to see your business more clearly?','ar'=>'هل أنت مستعد لرؤية أعمالك بوضوح أكبر؟','fr'=>'Prêt à voir votre activité plus clairement ?'],
        ],
    ];
}
